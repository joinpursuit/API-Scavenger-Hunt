...
* What would you do: If this error message was present I would not have to do anything

1. 301

* url: http://www.google.com/
* Description: URL has been permanently moved
* What would you do: Inform the user that they had a syntax error
1. 400

* Url:https://www.amazon.com/ap/oa
* Description: Bad Request
* What would you do: In form user that an error occurred when trying to process information
...
* What would you do: Inform user that they don't have access 

1. 404

* url: 'https://www.apple.com/hjblibv3ug;'2u9n6'
* Description: Not Found
* What would you do: Inform the user that the search that they are looking for is not found and, check the url for errors.

1. 418

   *Url:
    * Description:April Fool's joke
    * What would you do:
...
data:{
    ...
    "email": "core@pursuit.org",
    "hireable": null,
    "bio": "Pursuit is a social impact organization that creates transformation where it’s needed most.",
    "public_repos": 538,
    "public_gists": 0,
    "followers": 0,
    "following": 0,
    "created_at": "2013-10-31T19:21:11Z",
    "updated_at": "2019-04-30T19:24:27Z"
}
```
1. All the JavaScript repos on Github with Pursuit in their name
```
endpoint:https://api.github.com/users/joinpursuit/repos?language=javascript
data: {
        "id": 107791085,
...
```
endpoint:https://api.github.com/search/repositories?q=Pursuit+in:name+language:swift
data:{
            "id": 99703757,
